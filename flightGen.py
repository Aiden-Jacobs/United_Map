...
class Route_Manager():
    ...
    def sortByStops(self):
        tempL = self.getRoutes()
        tempL.sort(reverse = False, key = route.Route_.getNumFlights)
        return(Route_Manager(tempL))
    ...
    def sortByTime(self):
        tempL = self.getRoutes()
        tempL.sort(reverse = False, key = route.Route_.getRouteTime)
        return(Route_Manager(tempL))
...
RtMnger = Route_Manager(findOB.getFoundRoutes())
print("------------")
